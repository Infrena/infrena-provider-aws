...
// Overlay is the hand-maintained part of generation: what CloudFormation schemas cannot say.
type Overlay struct {
...
// OverlayReferences is the human review of derived reference edges, written with
