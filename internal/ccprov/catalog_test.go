...
func testCatalog() *catalog.Catalog {
	return &catalog.Catalog{
		...
		Types: []*catalog.Type{
			...
			{
				Name: "aws.ec2.instance", CFN: "AWS::EC2::Instance", RegionAttr: "region", Identifier: []string{"InstanceId"},
				HasUpdate: true, HasList: true, TagsAsMap: "Tags",
				Attributes: []*catalog.Attribute{
					{Name: "InstanceId", Kind: "string", Computed: true, Aliases: []string{"instance_id"}},
					{Name: "ImageId", Kind: "string", Optional: true, Computed: true, ForceNew: true, Aliases: []string{"ami", "image_id"}},
					{Name: "InstanceType", Kind: "string", Optional: true, Computed: true, Aliases: []string{"instance_type"}},
					{Name: "SubnetId", Kind: "string", Optional: true, Computed: true, ForceNew: true, Aliases: []string{"subnet_id"}},
					{Name: "Tags", Kind: "map", Optional: true, Computed: true, Shape: opaque()},
				},
			},
			{
