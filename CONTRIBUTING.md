...
written, and the constraints below are easy to get wrong and expensive to get wrong. A pull
request that cuts across one of them is not a bad pull request, but it is a conversation, and
it is cheaper to have before the code exists.
