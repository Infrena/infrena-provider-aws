...
| `Tags` |  | `map` | optional, computed, provider-chosen, replaces on change, tags map |  | A list of metadata items that you can associate with your auto scaling configuration resource. A tag is a key-value pair. |
