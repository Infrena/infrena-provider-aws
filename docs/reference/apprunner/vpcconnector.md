...
| `Tags` |  | `map` | replaces on change, write-only, tags map |  | A list of metadata items that you can associate with your VPC connector resource. A tag is a key-value pair. |
