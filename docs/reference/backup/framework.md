...
| `FrameworkTags` | framework_tags | `map` | optional, computed, provider-chosen, tags map |  | Metadata that you can assign to help organize the frameworks that you create. Each tag is a key-value pair. |
