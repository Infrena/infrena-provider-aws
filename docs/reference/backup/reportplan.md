...
| `ReportPlanTags` | report_plan_tags | `map` | tags map |  | Metadata that you can assign to help organize the report plans that you create. Each tag is a key-value pair. |
