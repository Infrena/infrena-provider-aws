...
| `Tags` |  | `map` | optional, computed, provider-chosen, tags map |  | An optional set of key-value pairs to associate arbitrary data of your choosing with the DB proxy endpoint. |
