...
**Import ID:** `<region>/AttachmentId` (AWS::NetworkManager::SiteToSiteVpnAttachment)
...
| `CoreNetworkId` | core_network_id | `string` | required, replaces on change | aws.corenetwork.CoreNetworkId | The ID of a core network where you're creating a site-to-site VPN attachment. |
...
| `VpnConnectionArn` | vpn_connection_arn | `string` | required, replaces on change |  | The ARN of the site-to-site VPN attachment. |
