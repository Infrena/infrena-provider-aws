...
| `CoreNetworkArn` | core_network_arn | `string` | optional, computed, provider-chosen |  | The Amazon Resource Name (ARN) of the core network. |
...
| `OdbNetworkArn` | odb_network_arn | `string` | optional, computed, provider-chosen |  | The Amazon Resource Name (ARN) of the ODB network. |
