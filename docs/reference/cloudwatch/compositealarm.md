...
| `Tags` |  | `map` | optional, computed, provider-chosen, tags map |  | A list of key-value pairs to associate with the composite alarm. You can associate as many as 50 tags with an alarm. |
