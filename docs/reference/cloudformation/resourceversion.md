...
**Import ID:** `<region>/Arn` (AWS::CloudFormation::ResourceVersion)

## Attributes

| Attribute | Also written as | Kind | Flags | References | Description |
|-----------|-----------------|------|-------|------------|-------------|
| `Arn` |  | `string` | computed |  | The Amazon Resource Name (ARN) of the type, here the ResourceVersion. This is used to uniquely identify a ResourceVersion resource |
...
| `ProvisioningType` | provisioning_type | `string` | computed |  | The provisioning behavior of the type. AWS CloudFormation determines the provisioning type during registration, based on the types of handlers in the schema handler package submitted. |
...
| `VersionId` | version_id | `string` | computed |  | The ID of the version of the type represented by this resource instance. |
