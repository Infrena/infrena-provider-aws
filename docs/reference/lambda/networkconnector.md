...
| `Tags` |  | `map` | optional, computed, provider-chosen, tags map |  | A list of tags to apply to the network connector. Use tags to categorize network connectors for cost allocation, access control, or operational management. |
