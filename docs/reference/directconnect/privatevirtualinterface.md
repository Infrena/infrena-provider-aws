# aws.privatevirtualinterface

**CloudFormation type:** `AWS::DirectConnect::PrivateVirtualInterface`

Resource Type definition for AWS::DirectConnect::PrivateVirtualInterface

Region attribute: `region`

**Import ID:** `<region>/VirtualInterfaceArn` (AWS::DirectConnect::PrivateVirtualInterface)
...
| `DirectConnectGatewayId` | direct_connect_gateway_id | `string` | optional, computed, provider-chosen, replaces on change | aws.directconnectgateway.DirectConnectGatewayId | The ID or ARN of the Direct Connect gateway. |
...
| `Tags` |  | `map` | optional, computed, provider-chosen, tags map |  | The tags associated with the private virtual interface. |
| `VirtualGatewayId` | virtual_gateway_id | `string` | optional, computed, provider-chosen, replaces on change |  | The ID or ARN of the virtual private gateway. |
| `VirtualInterfaceArn` | virtual_interface_arn | `string` | computed |  | The ID of the virtual interface. |
