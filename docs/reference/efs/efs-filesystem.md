...
| `ReplicationConfiguration` | replication_configuration | `map` | optional, computed, provider-chosen |  | Describes the replication configuration for a specific file system. |
